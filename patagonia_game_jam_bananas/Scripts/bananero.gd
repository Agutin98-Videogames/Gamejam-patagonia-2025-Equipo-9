...
#
#func drop_banana():
	#var plataforma_sostenedora
	#var plataforma_sostenedora2
	#plataforma_sostenedora = get_tree().current_scene.get_node("Plataforma")
	#plataforma_sostenedora2 = get_parent().get_node("Plataforma")
	#print("1  ",plataforma_sostenedora)
	#print("2  ",plataforma_sostenedora2)
	#var banana = banana_scene.instantiate()
	#banana.global_position = global_position + Vector2(186, 343)
	#get_parent().add_child(banana)
	#plataforma_sostenedora.queue_free()
