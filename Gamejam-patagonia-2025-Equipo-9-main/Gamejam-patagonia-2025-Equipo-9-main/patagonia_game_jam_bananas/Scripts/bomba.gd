...
@export var explosion_scene: PackedScene # Referencia a la explosión

@onready var area_de_deteccion = $Area2D # Referencia al Area2D para que funcione la detección
